...
public class Explicitwaitcommand {
	...
	public static void main(String[] args) {
		...
		try {
            ...
            System.out.println("Riprovo login con password corretta...");

        } catch (TimeoutException e) {
            System.out.println("Login riuscito al primo tentativo!");
        }
        //check if dashboard is showed
        mywait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h6[text()='Dashboard']")));
        System.out.println("Dashboard caricata correttamente.");
	}
}
...
public class XPathAxesDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //2) save link of first row
            WebElement firstLink=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//table[contains(@class,'dataTable')]/tbody/tr[1]/td[1]/a")));
